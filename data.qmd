...
ggplot(plot_data_sum[plot_data_sum$missing_count > 0, ], aes(x = column, y = missing_count)) +
  ...
  labs(title = "Number of missing values (All other columns have no missing values)", x = "Column Names", y = "Counts") +
  theme_minimal() +
  coord_flip()

ggplot(plot_data_percent[plot_data_percent$missing_count > 0, ], aes(x = column, y = missing_count)) +
  geom_bar(stat = "identity", color = "black") +
  labs(title = "Percent of missing values (All other columns have no missing values)", x = "Column Names", y = "Percentage") +
  theme_minimal() +
  coord_flip()
